...
5. **Regenerative Therapies** — Dark evergreen section with editorial 2-column list of PRP, regenerative cell therapies, peptides, exosomes, prolotherapy, IV/nutrient therapy. Each is presented educationally with a category tag and prose. A boxed disclaimer reinforces no-guarantee framing.
